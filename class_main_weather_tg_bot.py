...
# регистируемся на сайте и делаем api key:     https://home.openweathermap.org/api_keys
...
class Weather:
    ...
    def message_handler_2(self):
        @self.dp.message_handler(Text(equals=['Анекдот']))
...
if __name__ == '__main__':
    weat = Weather(tg_bot_token)
    # executor.start_polling(Weather.dp, skip_updates=True)
    executor.start_polling(weat.dp)
